...
public class Persona {
    ...
    public Persona(Long id, String nombre, String apellido, String email, String fechaNac, String sobreMi, String ciudadProvincia, String urlFotoPerfil, String urlFotoBackground) {
        this.id = id;
        this.nombre = nombre;
